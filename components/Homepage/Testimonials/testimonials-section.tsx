...
import { GridPattern } from '@/components/Homepage/Testimonials/grid-pattern';
		...
		<section className="relative w-full pt-10 pb-20 px-4">
			...
			<div className="mx-auto max-w-5xl space-y-8">
				<div className="flex flex-col gap-2">
					<h1 className="text-6xl font-bold font-primary text-brand  text-balance md:text-4xl lg:text-5xl xl:text-6xl xl:font-extrabold">
					 Real Voices
					</h1>
					<p className="text-muted-foreground text-sm md:text-base lg:text-lg">
						See how many people trust our trekking services to create unforgettable memories.
					</p>
				</div>
